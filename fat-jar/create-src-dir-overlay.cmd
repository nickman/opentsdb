...
CALL :linkfile %TSDB_SRC%\create_table.sh %TSDB_MVN%\src\main\resources\create_table.sh
CALL :linkfile %TSDB_SRC%\mygnuplot.bat %TSDB_MVN%\src\main\resources\mygnuplot.bat
CALL :linkfile %TSDB_SRC%\mygnuplot.sh %TSDB_MVN%\src\main\resources\mygnuplot.sh
